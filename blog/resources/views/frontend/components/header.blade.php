                ...
                <div class="top-detail">
                    ...
                    <div class="disflow">
                        <div class="expand lang-all disflow">
                            <a href="#"><img src="{{asset('frontend/img/country/en.gif')}}" alt="">English</a>
                            <ul class="restrain language">
                                <li><a href="#"><img src="{{asset('frontend/img/country/it.gif')}}" alt="">italiano</a>
                                </li>
                                <li><a href="#"><img src="{{asset('frontend/img/country/nl_nl.gif')}}" alt="">Nederlands</a>
                                </li>
                                <li><a href="#"><img src="{{asset('frontend/img/country/de_de.gif')}}"
                                                     alt="">Deutsch</a></li>
                                <li><a href="#"><img src="{{asset('frontend/img/country/en.gif')}}" alt="">English</a>
                                </li>
                            </ul>
                        </div>
                        <div class="expand lang-all disflow">
                                    ...
                                    <ul class="cart-list">
                                        <li>
                                            <a class="sm-cart-product" href="product-details.html">
                                                <img src="{{asset('frontend/img/products/sm-products/cart1.jpg')}}"
                                                     alt="">
                                            </a>
                                            <div class="small-cart-detail">
                                                <a class="remove" href="#"><i class="fa fa-times-circle"></i></a>
                                                <a href="#" class="edit-btn"><img
                                                        src="{{asset('frontend/img/btn_edit.gif')}}" alt="Edit Button"/></a>
                                        ...
                                        <li>
                                            <a class="sm-cart-product" href="product-details.html">
                                                <img src="{{asset('frontend/img/products/sm-products/cart2.jpg')}}"
                                                     alt="">
                                            </a>
                                            <div class="small-cart-detail">
                                                <a class="remove" href="#"><i class="fa fa-times-circle"></i></a>
