                ...
                <div class="col-md-12">
                    <div class="container-inner">
                        <ul>
                            ...
                            <li class="category3"><span>{{$cateProduct->name}}</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                                                ...
                                                <div class="two-product">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="product-img">
                                                            <a href="{{route('frontend.product.detail', [$product->slug, $product->id])}}">
                                                            ...
                                                            <div class="action-zoom">
                                                                <div class="add-to-cart">
                                                                    <a href="{{route('frontend.product.detail', [$product->slug, $product->id])}}" title="Quick View"><i class="fa fa-search-plus"></i></a>
                                                                </div>
                                                            </div>
                                                            <div class="actions">
                                                        ...
                                                        <div class="product-content">
                                                            <h2 class="product-name"><a href="{{route('frontend.product.detail', [$product->slug, $product->id])}}">{{$product->name}}</a></h2>
